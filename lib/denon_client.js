...
class DenonClient extends Connection {
  ...
  constructor(host,port=23) {
    ...
    this.regExTable = {
      ...
      'zone1': {
        regEx: DenonRegex.constructStatusChangedRegex(Options.Zone1Options),
        /**
         * @event zone1Changed
         * @param {Zone1Options} zone1Status The current display dim status
         */
        emit: 'zone1Changed'
      },
      'zone2': {
      ...
      'zone3': {
        regEx: DenonRegex.constructStatusChangedRegex(Options.Zone32Options),
        /**
         * @event zone3Changed
         * @param {Zone3Options} zone3Status The current display dim status
         */
        emit: 'zone3Changed'
      }
    };
  ...
  /**
   * Sets the zone 1 state of the Denon AVR. (On / Off).
   * Use {Zone1Options}.
   *
   * @method setZone1
   * @param {Zone1Options} zone1Options [The zone1 option]
   * @return {Promise} [A response]
   */
  setZone1(zone1Options) {

    return this.sendCommand('ZM', zone1Options,
      this.getEvent('zone1'));
  }
  ...
  getZone1() {
    ...
    return this.sendCommand('ZM', Options.Zone1Options.Status,
      this.getEvent('zone1'));
  }
  ...
  /**
   * Sets the zone 3 state of the Denon AVR. (On / Off).
   * Use {Zone3Options}.
   *
   * @method setZone3
   * @param {Zone3Options} zone3Options [The zone3 option]
   * @return {Promise} [A response]
   */
  setZone3(zone3ptions) {

    return this.sendCommand('Z3', zone3Options,
      this.getEvent('zone3'));
  }

  /**
   * Returns the current zone 3 status of the Denon AVR.
   *
   * @method getZone3
   * @return {Promise} [A response]
   */
  getZone3() {
    ...
    return this.sendCommand('Z3', Options.Zone3Options.Status,
      this.getEvent('zone3'));
  }
